...
| --------------- | -------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `github_token`  | No       | `github.token` | GitHub token with `contents: write` permission. Defaults to the built-in `github.token`. Only set this if you need a PAT with elevated permissions.                      |
